...
namespace AgriculturalTech.API.Data.Migrations
{
    ...
    [Migration("20251020212946_InitialCreate")]
            ...
            modelBuilder.Entity("AgriculturalTech.API.Data.Models.CropType", b =>
                {
                    ...
                    b.Property<double?>("IdealHumidityMax")
                        .HasColumnType("float");

                    b.Property<double?>("IdealHumidityMin")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("IdealTemperatureMax")
                        .HasColumnType("float");

                    b.Property<double?>("IdealTemperatureMin")
                        .HasColumnType("float");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Vegetables",
                            CreatedAt = new DateTime(2025, 10, 20, 21, 29, 45, 558, DateTimeKind.Utc).AddTicks(7517),
                            DescriptionAr = "خضار شائعة في الحدائق",
                            DescriptionEn = "Popular garden vegetable",
                            GrowingDurationDays = 75,
                            IdealHumidityMax = 80.0,
                            IdealHumidityMin = 60.0,
                            IdealPhMax = 6.7999999999999998,
                            IdealPhMin = 6.0,
                            IdealTemperatureMax = 27.0,
                            IdealTemperatureMin = 18.0,
                            ImageUrl = "",
                            IsActive = true,
                            NameAr = "طماطم",
                            NameEn = "Tomato",
                        ...
                        new
                        {
                            Id = 2,
                            Category = "Grains",
                            CreatedAt = new DateTime(2025, 10, 20, 21, 29, 45, 558, DateTimeKind.Utc).AddTicks(7534),
                            DescriptionAr = "محصول حبوب أساسي",
                            DescriptionEn = "Staple grain crop",
                            GrowingDurationDays = 120,
                            IdealHumidityMax = 70.0,
                            IdealHumidityMin = 50.0,
                            IdealPhMax = 7.5,
                            IdealPhMin = 6.0,
                            IdealTemperatureMax = 25.0,
                            IdealTemperatureMin = 15.0,
                            ImageUrl = "",
                            IsActive = true,
                            NameAr = "قمح",
                            NameEn = "Wheat",
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Grains",
                            CreatedAt = new DateTime(2025, 10, 20, 21, 29, 45, 558, DateTimeKind.Utc).AddTicks(7539),
                            ...
                            IdealHumidityMin = 60.0,
                            IdealPhMax = 7.0,
                            IdealPhMin = 5.7999999999999998,
                            IdealTemperatureMax = 30.0,
                            IdealTemperatureMin = 20.0,
                            ImageUrl = "",
                            IsActive = true,
                            NameAr = "ذرة",
                            NameEn = "Corn (Maize)",
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Vegetables",
                            CreatedAt = new DateTime(2025, 10, 20, 21, 29, 45, 558, DateTimeKind.Utc).AddTicks(7543),
                            DescriptionAr = "محصول خضار جذري",
                            DescriptionEn = "Root vegetable crop",
                            GrowingDurationDays = 100,
                            IdealHumidityMax = 80.0,
                            IdealHumidityMin = 70.0,
                            IdealPhMax = 6.5,
                            IdealPhMin = 5.0,
                            IdealTemperatureMax = 20.0,
                            IdealTemperatureMin = 15.0,
                            ImageUrl = "",
                            IsActive = true,
                            NameAr = "بطاطس",
                        ...
                        new
                        {
                            Id = 5,
                            Category = "Grains",
                            CreatedAt = new DateTime(2025, 10, 20, 21, 29, 45, 558, DateTimeKind.Utc).AddTicks(7547),
                            DescriptionAr = "حبوب غذائية أساسية",
                            DescriptionEn = "Staple food grain",
                            GrowingDurationDays = 120,
                            IdealHumidityMax = 90.0,
                            IdealHumidityMin = 70.0,
                            IdealPhMax = 6.5,
                            IdealPhMin = 5.5,
                            IdealTemperatureMax = 35.0,
                            IdealTemperatureMin = 20.0,
                            ImageUrl = "",
                            IsActive = true,
                            NameAr = "أرز",
